 ...
 * 
 * For licensing inquiries: papica777@gmail.com
 * ═══════════════════════════════════════════════════════════════════════════════
 */
...
export class DashboardServer extends EventEmitter {
    ...
    private handleHttpRequest(req: http.IncomingMessage, res: http.ServerResponse): void {
        ...
        res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' ws: http: https:; img-src 'self' data:;");
